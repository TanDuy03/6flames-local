    ...
    <div class="container-fluid px-5">
        <div class="row justify-content-start">
            ...
            <div class="col-lg-3 col-md-6 mb-3">
                ...
                <div class="col-lg-12 d-flex gap-3 mb-3 social-footer justify-content-start">
                    <a href="https://www.facebook.com/sneaker.square.hcm" target="_blank">
        ...
        <div class="footer-bottom d-flex justify-content-center align-items-center flex-wrap">
            <p class="mb-3 text-center">
                ...
                All rights reserved. Designed by <a href="https://www.facebook.com/sneaker.square.hcm" target="_blank" class="link_team">6Flames.</a>
            </p>
        </div>
    </div>
</footer>
