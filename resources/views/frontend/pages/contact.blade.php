                            ...
                            <form action="{{route('contact-form.sto')}}" method="post" id="formContact">@csrf
                                <div class="row">
                                    <div class="col-lg-6 form-group mb-4 position-relative">
                                        ...
                                        <input type="text" name="name" class="form-control" placeholder="Nhập tại đây..." id="fullname" autocomplete="off"
                                        >
                                    ...
                                    <div class="col-lg-6 form-group mb-4 position-relative">
                                        ...
                                        <input type="email" name="email" class="form-control" placeholder="Nhập tại đây..." id="email" autocomplete="off">
                                        <small class="text-error position-absolute text-danger fst-italic">a</small>
                                        @error('email')
                                            <small class="text-danger fst-italic">
                                                {{ $message }}
                                    ...
                                    <div class="col-lg-6 form-group mb-4 position-relative">
                                        ...
                                        <input type="text" name="phone" class="form-control" placeholder="Nhập tại đây..." id="phone" autocomplete="off">
                                        <small class="text-error position-absolute text-danger fst-italic">a</small>
                                    </div>
                                    <div class="col-lg-6 form-group mb-4 position-relative">
                                        <label for="problem" class="form-label">Tiêu đề</label>
                                        <input type="text" name="title" class="form-control" placeholder="Nhập tại đây..." id="problem" autocomplete="off">
                                        <small class="text-error position-absolute text-danger fst-italic">a</small>
                                        @error('title')
                                            <small class="text-danger fst-italic">
                                                {{ $message }}
