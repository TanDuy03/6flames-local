    ...
    @hasanyrole('Quản trị viên|Nhân viên|Cộng tác viên')
        <div class="row">
                    ...
                    <div class="d-flex align-items-end row">
                        <div class="col-sm-7">
                            <div class="card-body">
                                ...
                                <p class="mb-4 fs-6">
                                    Hôm nay cửa hàng có <span class="fw-bold">{{ $totalOrderToday }}</span> đơn hàng, trong đó có
                                    <span class="fw-bold">{{ $totalOrder }}</span> đơn hàng mới cần được xử lí.
                                </p>
            ...
            <div class="col-lg-4 order-1 mb-4">
                <div class="row h-100">
                    <div class="col-lg-6 col-6 mb-4 h-100">
                        <div class="card h-100">
                            <div class="card-body">
                        ...
                        <div class="card h-100">
                            <div class="card-body">
                                ...
                                <div class="d-flex flex-column gap-2">
                                    ...
                                    <h3 class="card-title text-nowrap mb-1 fs-4 title__truncate" id="visitorRealtime">
                                        {{ $onlineVisitorCount }}</h3>
                                </div>
                            </div>
                        </div>
                    </div>
                    ...
                    <div class="col-lg-3 col-md-6 mb-4">
                        <div class="card h-100">
                            <div class="card-body">
                                <div class="card-title d-flex align-items-start justify-content-between">
                                    <div class="avatar avatar-top-left flex-shrink-0 rounded">
                                        <i class='bx bxs-window-alt fs-3 icon-agent'></i>
                                    </div>
                                </div>
                                <div class="d-flex flex-column gap-2">
                                    <span class="d-block mb-1">Trình duyệt</span>
                                    <h3 class="card-title text-nowrap mb-1 fs-5 title__truncate">
                                        {{ $browser }}
                                    </h3>
                                </div>
                            </div>
                    ...
                    <div class="col-lg-3 col-md-6 mb-4">
                        <div class="card h-100">
                            <div class="card-body">
                                <div class="card-title d-flex align-items-start justify-content-between">
                                    <div class="avatar avatar-top-left flex-shrink-0 rounded">
                                        <i class='bx bxs-devices fs-3 icon-agent'></i>
                                    </div>
                                </div>
                                <div class="d-flex flex-column gap-2">
                                    <span class="d-block mb-1">Thiết bị</span>
                                    <h3 class="card-title text-nowrap mb-1 fs-5 title__truncate">
                                        {{ $device }}
                                    </h3>
                                </div>
                    ...
                    <div class="col-lg-3 col-md-6 mb-4">
                        <div class="card h-100">
                            <div class="card-body">
                                <div class="card-title d-flex align-items-start justify-content-between">
                                    <div class="avatar avatar-top-left flex-shrink-0 rounded">
                                        <i class='bx bx-cog fs-3 icon-agent'></i>
                                    </div>
                                </div>
                                <div class="d-flex flex-column gap-2">
                                    <span class="d-block mb-1">Hệ điều hành</span>
                                    <h3 class="card-title text-nowrap mb-1 fs-5 title__truncate">
                                        {{ $platform }}
                                    </h3>
                                </div>
                    ...
                    <div class="col-lg-3 col-md-6 mb-4">
                        <div class="card h-100">
                            <div class="card-body">
                                <div class="card-title d-flex align-items-start justify-content-between">
                                    <div class="avatar avatar-top-left flex-shrink-0 rounded">
                                        <i class='bx bx-check-shield fs-3 icon-agent'></i>
                                    </div>
                                </div>
                                <div class="d-flex flex-column gap-2">
                                    <span class="d-block mb-1">Phiên bản</span>
                                    <h3 class="card-title text-nowrap mb-1 fs-5 title__truncate">
                                        {{ $platVersion }}
                                    </h3>
                                </div>
                                ...
                                <div class="card-body">
                                    <div class="row mb-1">
                                        <div class="col-md-3">
                                            ...
                                            <input type="text" id="start_coupon" style="font-size: 14px" name="from_date"
                                                class="form-control datepicker btn-sm">
                                            <small class="error-text text-danger fst-italic">a</small>
                                        </div>
                                        <div class="col-md-3">
                                            <label for="">Đến ngày:</label>
                                            <input type="text" id="end_coupon" style="font-size: 14px" name="to_date"
                                                class="form-control btn-sm datepicker">
                                            <small class="error-text text-danger fst-italic">a</small>
                                        </div>
                                        <div class="col-md-4">
                                            <label for="color-product" style="">Lọc theo:</label>
                                            <select class="dashboard-filter form-select btn-sm" style="font-size: 14px"
                                                id="color-product" name="cate">
                                                ...
                                                <div class="accordion-item rounded-0 border-0">
                                                    <div class="sidebar-categories">
                                                        ...
                                                        <div id="collapseThree" class="accordion-collapse collapse show"
                                                            ...
                                                            <ul class="p-0">
                                                                <form action="{{ route('export.scvday') }}" method="POST"
                                                                    enctype="multipart/form-data" class="mx-0 mb-0">
                                                                    @csrf
                                                                    <input type="submit" name="export_scv_day"
                                                                        value="Theo ngày" class="dropdown-item">
                                                                </form>
                                                                <form action="{{ route('export.scvweek') }}" method="POST"
                                                                    enctype="multipart/form-data" class="mb-0 mx-0">
                                                                    @csrf
                                                                    <input type="submit" name="export_week"
                                                                        value="7 ngày qua" class="dropdown-item">
                                                                </form>
                                                                <form action="{{ route('export.scvmonth') }}" method="POST"
                                                                    enctype="multipart/form-data" class="mb-0 mx-0">
                                                                    @csrf
                                                                    <input type="submit" name="export_month"
                                                                        value="Tháng này" class="dropdown-item">
                                                                </form>
                                                                <form action="{{ route('export.scvmonthprev') }}"
                                                                    method="POST" enctype="multipart/form-data"
                                                                    class="mb-0 mx-0">
                                                                    @csrf
                                                                    <input type="submit" name="export_monthprev"
                                                                        value="Tháng trước" class="dropdown-item">
                                                                </form>
                                                                <form action="{{ route('export.scv') }}" method="POST"
                                                                    enctype="multipart/form-data" class="">
                                                                    @csrf
                                                                    <input type="submit" name="export_scv" value="Năm qua"
                                                                        class="dropdown-item">
                                                                </form>
                                                            </ul>
                                                        </div>
                    ...
                    <div class="col-md-12 col-lg-12 mb-4">
                        <div class="card">
                            <div class="card-header d-flex align-items-center justify-content-between">
                                <h5 class="card-title m-0 me-2"><a href="{{ route('coupon.index') }}"
                                        style="color:#697a8d;">Mã giảm giá</a></h5>
                                <div class="dropdown">
                                    <button class="btn p-0" type="button" id="cardOpt1" data-bs-toggle="dropdown"
                                        aria-haspopup="true" aria-expanded="false">
                                        <i class="bx bx-dots-vertical-rounded"></i>
                                    ...
                                    <div class="dropdown-menu mb-0 pb-0" aria-labelledby="cardOpt1">
                                        <form action="{{ route('exportcou.scv') }}" method="POST"
                                            enctype="multipart/form-data">
                                            @csrf
                                            <input type="submit" name="export_scv" value="Xuất báo cáo"
                                                class="dropdown-item">
                                        </form>
                                    </div>
                                </div>
                                ...
                                <ul class="p-0 m-0">
                                    <li class="d-flex mb-4 pb-1">
                                        <div class="avatar flex-shrink-0 me-3">
                                            <img src="/backend/assets/img/icons/unicons/order5.png" alt="User"
                                                class="rounded h-100 w-100" />
                                        </div>
                                    ...
                                    <li class="d-flex mb-4 pb-1">
                                        <div class="avatar flex-shrink-0 me-3">
                                            <img src="/backend/assets/img/icons/unicons/order6.png" alt="User"
                                                class="rounded h-100 w-100" />
                                        </div>
                                        <div class="d-flex w-100 flex-wrap align-items-center justify-content-between gap-2">
                                            <div class="me-2">
                ...
                <div class="card h-100">
                    <div class="card-header d-flex align-items-center justify-content-between pb-0">
                        <div class="card-title mb-0">
                            ...
                            @else
                                <small class="text-muted">Doanh thu đơn hàng
                                    {{ number_format($dataOrder['revenueOrder'], 0, ',', '.') }} VNĐ</small>
                            @endif
                        </div>
                    </div>
                    <div class="card-body">
                        ...
                        <div class="tab-content p-0">
                            <div class="tab-pane fade show active" id="navs-tabs-line-card-income" role="tabpanel">
                                <div class="d-flex p-4 pt-3 justify-content-between">
                                    <div class="d-flex">
                                        <div class="avatar flex-shrink-0 me-3">
                                            <img src="/backend/assets/img/icons/unicons/account-new.png" alt="User"
                                                class="h-100 w-100" />
                                        </div>
                                        <div>
                ...
                <div class="card h-100">
                    ...
                    <div class="card-body">
                        <ul class="p-0 m-0">
                            ...
                            <li class="d-flex mb-4 pb-1">
                                <div class="avatar flex-shrink-0 me-3">
                                    <img src="/backend/assets/img/icons/unicons/order7.png" alt="User"
                                        class="rounded h-100 w-100" />
                                </div>
                                <div class="d-flex w-100 flex-wrap align-items-center justify-content-between gap-2">
                                    <div class="me-2">
                            ...
                            <li class="d-flex mb-4 pb-1">
                                <div class="avatar flex-shrink-0 me-3">
                                    <img src="/backend/assets/img/icons/unicons/order9.png" alt="User"
                                        class="rounded h-100 w-100" />
                                </div>
                                <div class="d-flex w-100 flex-wrap align-items-center justify-content-between gap-2">
                                    <div class="me-2">
...
@push('script-backend')
    <script type="text/javascript">
        $(document).ready(function() {
            ...
            //total order
            var options = {
                series: [{{ $dataOrder['orderWaitDelivery'] }}, {{ $dataOrder['orderDelivering'] }},
                    {{ $dataOrder['orderDelivered'] }}, {{ $dataOrder['orderFail'] }}
                ],
