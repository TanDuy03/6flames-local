...
class PaymentCheckoutController extends Controller
{
    ...
    public function paymentCheckout(Request $request)
    {
        if (isset($_POST['payUrl'])) {
            ...
            $redirectUrl = "https://6flames.id.vn/kiem-tra-trang-thai-dat-hang";
            $ipnUrl = "https://6flames.id.vn/kiem-tra-trang-thai-dat-hang";
            $extraData = "";
            $serectkey = $secretKey;
            $requestId = time() . "";
            ...
            $vnp_Returnurl = "https://6flames.id.vn/kiem-tra-trang-thai-dat-hang";
